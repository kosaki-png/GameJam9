...
#include <d3d11.h>
#include "../2d/WICTextureLoader.h"
#include "../ShaderBase/VertexShader.h"
#include "../ShaderBase/PixelShader.h"
...
public:
	...
	*/
	...
	void SetTransform(BaseCamera* camera, LightGroup* lightgroup);

	void SetScreenMode(bool flag);
	bool GetScreenMode() { return screenMode; }
...
private:
	...
	bool screenMode = false;	// スクリーンモード
};
